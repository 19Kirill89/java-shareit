...
public class UserService {
    ...
    public UserDto create(UserDto userDto) {
        ...
        return mapper.UserDto(userRepository.create(user));
    }
    ...
    public UserDto update(UserDto userDto, Long id) {
        ...
        return mapper.UserDto(updateUser);
    }
    ...
    public UserDto delete(Long userId) {
        ...
        if (!userRepository.isUserInBD(userId)) {
            throw new NotFoundException("User with ID = " + userId + " not found.");
        }
        return mapper.UserDto(userRepository.delete(userId));
    }
    ...
    public UserDto getUserById(Long id) {
        ...
        return mapper.UserDto(userRepository.getUserById(id));
    }
}