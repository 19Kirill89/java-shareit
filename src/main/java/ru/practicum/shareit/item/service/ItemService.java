...
public class ItemService {
    ...
    public ItemDto create(ItemDto itemDto, Long ownerId) {
        ...
        if (userService.getUserById(ownerId) != null) {
            newItemDto = mapper.itemDto(itemRepository.create(mapper.item(itemDto, ownerId)));
        }
        return newItemDto;
    }
    ...
    public ItemDto update(ItemDto itemDto, Long ownerId, Long itemId) {
        ...
        return mapper.itemDto(itemRepository.update(mapper.item(itemDto, ownerId)));
    }
    ...
    public ItemDto delete(Long itemId, Long ownerId) {
        ...
        return mapper.itemDto(itemRepository.delete(itemId));
    }
    ...
    public ItemDto getItemById(Long itemId) {
        return mapper.itemDto(itemRepository.getItemById(itemId));
    }
